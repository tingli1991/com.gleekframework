...
namespace Com.GleekFramework.HttpSdk
{
    ...
    public partial class HttpClientService : IBaseAutofac
    {
        ...
        {
            return HttpClientFactory.PutAsync<R, string>(HttpContextAccessor, url, data, headers, param);
        }
        ...
        {
            return HttpClientFactory.PutAsync<R, T>(HttpContextAccessor, url, data, headers, param);
        }
