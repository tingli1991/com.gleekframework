...
namespace Com.GleekFramework.MongodbSdk
{
        ...
        where T : class, IMEntity
    {
        ...
        public async Task InsertOneAsync(T docment, CancellationToken cancellationToken = default)
            => await Collection.InsertOneAsync(docment, cancellationToken: cancellationToken);
        ...
        /// <param name="isOrdered">是否有序的插入(默认：false)</param>
        /// <param name="cancellationToken">取消令牌</param>
        public async Task InsertManyAsync(IEnumerable<T> docments, bool isOrdered = false, CancellationToken cancellationToken = default)
            => await Collection.InsertManyAsync(docments, MongoConstant.GetInsertManyOptions(isOrdered), cancellationToken);
        ...
        /// <param name="cancellationToken">取消令牌</param>
        /// <returns></returns>
        public async Task UpdateOneAsync(Expression<Func<T, bool>> filter, UpdateDefinition<T> update, CancellationToken cancellationToken = default)
        ...
        /// <param name="update">更新对象</param>
        /// <param name="cancellationToken">取消令牌</param>
        public async Task UpdateManyAsync(Expression<Func<T, bool>> filter, UpdateDefinition<T> update, CancellationToken cancellationToken = default)
        ...
        public async Task<T> GetFirstOrDefaultAsync(Expression<Func<T, bool>> filter, CancellationToken cancellationToken = default)
            => await Collection.Find(filter).Limit(1).SingleOrDefaultAsync(cancellationToken);
        ...
        /// <param name="cancellationToken">取消令牌</param>
        /// <returns></returns>
        public async Task<R> GetFirstOrDefaultAsync<R>(Expression<Func<T, bool>> filter, CancellationToken cancellationToken = default)
            where R : class => await MapAsync<R>(GetFirstOrDefaultAsync(filter, cancellationToken));
        ...
        /// <param name="cancellationToken">取消令牌</param>
        /// <returns></returns>
        public async Task<IEnumerable<T>> GetListAsync(Expression<Func<T, bool>> filter, int pageSize, CancellationToken cancellationToken = default)
            => await Collection.Find(filter).Limit(pageSize).ToListAsync(cancellationToken);
        ...
        /// <param name="cancellationToken">取消令牌</param>
        /// <returns></returns>
        public async Task<IEnumerable<R>> GetListAsync<R>(Expression<Func<T, bool>> filter, CancellationToken cancellationToken = default)
            where R : class => await MapAsync<R>(GetListAsync(filter, cancellationToken));
        ...
        /// <param name="cancellationToken">取消令牌</param>
        /// <returns></returns>
        public Task<IEnumerable<R>> GetListAsync<R>(Expression<Func<T, bool>> filter, int pageSize, CancellationToken cancellationToken = default)
            where R : class => MapAsync<R>(GetListAsync(filter, pageSize, cancellationToken));
    }
}