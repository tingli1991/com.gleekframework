    ...
    public class KafkaController : BaseController
    {
        ...
        public async Task TestAsync()
        {
            for (int i = 0; i < 1000; i++)
            {
                ...
                var response = await KafkaClientService.PublishManyAsync(RabbitConfig.KafkaDefaultClientHosts, KafkaTopicConstant.DEFAULT_TOPIC, MessageType.CUSTOMER_TEST_KAFKA_NAME, dataList, serialNo, headers);
