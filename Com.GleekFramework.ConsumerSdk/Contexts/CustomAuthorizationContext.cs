...
namespace Com.GleekFramework.ConsumerSdk
{
    ...
    /// 自定义授权上下文
    /// </summary>
    public class CustomAuthorizationContext
    {
        /// <summary>
        /// 处理方法的实例对象
        /// </summary>
        ...
        /// <returns></returns>
        public static CustomAuthorizationContext CreateCustomAuthorizationContext(object handler, MessageBody messageBody, Dictionary<string, object> actionArguments = null)
        {
